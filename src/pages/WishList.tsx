...
function WishList() {
  ...
  return (
    <div className=" w-[80%] min-h-screen md:w-full md:px-4 sm:px-1 pb-10 mx-auto">
            ...
            <>
              ...
              >
                ...
                <div
                  ...
                  className="flex items-center  p-2 rounded-md md:hidden  cursor-pointer hover:opacity-60 bg-black-alt w-fit"
                >
